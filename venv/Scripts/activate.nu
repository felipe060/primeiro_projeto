...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\lipe2\python\sistema_login\teste_9\venv'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\lipe2\python\sistema_login\teste_9\venv\Scripts\deactivate.nu'
